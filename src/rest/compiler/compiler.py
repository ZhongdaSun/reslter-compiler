...
from rest.compiler.annotations import (
...
from rest.compiler.dependency_analysis_types import (
    ...
    RequestData,
    is_path_parameter)
from rest.compiler.swagger_visitor import (
    SchemaUtilities,
    SchemaCache,
    generate_grammar_element_for_schema)
from rest.compiler.swagger import RequestInfo
...
from rest.compiler.example import (
    FileExamplePayload,
    ExamplePath,
    get_example_config,
    ExampleConfigFile,
...
from rest.compiler.xms_paths import (
    XMsPath,
    get_x_ms_path)
from rest.compiler.dependencies import (
    DependencyLookup,
    extract_dependencies)
from rest.swagger.objects import Parameter
