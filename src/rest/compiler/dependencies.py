...
from rest.compiler.access_paths import (
    AccessPath,
    EmptyAccessPath)
        ...
        if possible_producers is None:
            ...
            if len(possible_producers) > 0:
                ...
                if len(possible_producers) > 1:
                    ...
                    from rest.compiler.dependency_analysis_types import sort_by_method
...
def debug_file_log(file_info: str, consumers: Optional[list[tuple[RequestId, list[Consumer]]]],
    ...
    if file_info == "consumer":
        ...
        from rest.compiler.workflow import Constants
        from rest.compiler.dependency_analysis_types import sort_by_parameter_kind_debug
