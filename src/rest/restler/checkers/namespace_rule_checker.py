...
from rest.restler.engine.core.request_utilities import NO_TOKEN_SPECIFIED
from rest.restler.engine.core.request_utilities import NO_SHADOW_TOKEN_SPECIFIED
