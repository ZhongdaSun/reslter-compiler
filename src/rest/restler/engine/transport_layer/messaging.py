...
import time
import threading
from rest.restler.utils.logging.trace_db import (DB as TraceDatabase,
                                            SequenceTracker)
from rest.restler.utils.formatting import iso_timestamp
...
from rest.restler.engine.errors import TransportLayerException
from rest.restler.restler_settings import ConnectionSettings, LogSettings
...
class HttpSock(object):
    ...
    def set_up_connection(self):
        try:
            ...
            """
            if self.connection_settings.use_ssl:
    ...
    def sendRecv(self, message, req_timeout_sec, reconnect=False):
        ...
        try:
            ...
            if not Settings().use_test_socket:
                ...
                logger.write_to_main(f"received_response={received_response}", True)
