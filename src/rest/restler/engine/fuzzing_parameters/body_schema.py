...
from rest.restler.engine.fuzzing_parameters.request_params import *
from rest.restler.engine.fuzzing_parameters.request_schema_parser import *
from rest.restler.engine.fuzzing_parameters.fuzzing_config import *
...
class BodySchema():
    ...
    def fuzz_body_blocks(self, config) -> list:
        ...
        import rest.restler.engine.fuzzing_parameters.fuzzing_utils as fuzzing_utils
        # compose
