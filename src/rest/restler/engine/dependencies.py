...
class GarbageCollector:
    ...
    def run(self):
        ...
        if not self._created_network_log:
            from restler.utils.restler_logger import create_network_log
            from restler.utils.restler_logger import LOG_TYPE_GC
        ...
        try:
            ...
            print(error_str)
            from restler.utils.restler_logger import garbage_collector_logging as CUSTOM_LOGGING
    ...
    def apply_destructors(self, destructors, max_aged_objects=100):
        ...
        """
        from restler.engine.core.async_request_utilities import try_async_poll
        ...
        from restler.utils.restler_logger import raw_network_logging as RAW_LOGGING
        from restler.utils.restler_logger import garbage_collector_logging as CUSTOM_LOGGING
        from restler.engine.core import request_utilities
