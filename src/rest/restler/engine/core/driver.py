...
from rest.restler.utils.logging.trace_db import SequenceTracker, get_sequences_from_db
import rest.restler.utils.saver as saver
import rest.restler.utils.formatting as formatting
import rest.restler.engine.dependencies as dependencies
import rest.restler.engine.core.sequences as sequences
...
from rest.restler.engine.core.fuzzing_requests import FuzzingRequestCollection
from rest.restler.engine.core.requests import GrammarRequestCollection
from rest.restler.engine.core.request_utilities import execute_token_refresh_cmd
from rest.restler.engine.core.request_utilities import get_hostname_from_line
from rest.restler.engine.core.fuzzing_monitor import Monitor
from rest.restler.engine.errors import TimeOutException
from rest.restler.engine.errors import ExhaustSeqCollectionException
...
def render_one(seq_to_render, ith, checkers, generation, global_lock, garbage_collector):
    ...
    n_minutes = 60
    logger.write_to_main("render_one kick in.....", False)
    ...
    # bfs needs to be exhaustive to provide full grammar coverage
        ...
        logger.write_to_main("Settings().fuzzing_mode in ['bfs', 'bfs-fast', 'test-all-combinations']",
                             False)
...
def render_with_cache(seq_collection, fuzzing_pool, checkers, generation, global_lock, seq_rendering_cache,
    ...
    for current_seq in seq_collection:
        ...
        while prefix_start < current_seq.length - 1:
            renderings_found = seq_rendering_cache.get_renderings(current_seq.requests[prefix_start:],
