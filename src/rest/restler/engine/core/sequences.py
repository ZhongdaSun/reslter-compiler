...
import rest.restler.engine.core.async_request_utilities as async_request_utilities
import rest.restler.engine.core.request_utilities as request_utilities
import rest.restler.engine.core.status_codes_monitor as status_codes_monitor

from rest.restler.engine.core.fuzzing_monitor import Monitor
from rest.restler.engine.core.requests import FailureInformation
from rest.restler.restler_settings import Settings, LogSettings
from rest.restler.engine.bug_bucketing import BugBuckets
...
from rest.restler.engine.errors import TimeOutException
from rest.restler.engine.errors import NoTokenSpecifiedException
from rest.restler.engine.transport_layer.response import RESTLER_INVALID_CODE
from rest.restler.utils.restler_logger import raw_network_logging as RAW_LOGGING
from rest.restler.utils.restler_logger import custom_network_logging as CUSTOM_LOGGING
from rest.restler.utils.logging.trace_db import SequenceTracker
...
class Sequence(object):
    ...
    def render(self, candidate_values_pool, lock, preprocessing=False, postprocessing=False):
        ...
        def render_prefix():
            ...
            self.create_prefix_once, self.re_render_prefix_on_success = Settings().get_cached_prefix_request_settings(
                last_req.endpoint_no_dynamic_objects, last_req.method)
    ...
    def replay_sequence(self, candidate_values_pool=None):
        ...
        def send_and_parse(replay_sequence, request_data, request_in_collection):
            ...
            if request_data.replay_blocks is not None and request_in_collection is not None:
                ...
                logger.write_to_main("rendered_data={}".format(rendered_data), True)
                response = request_utilities.send_request_data(rendered_data, reconnect=True)
