...
""" Useful hooks to collect coverage information of python services. """
...
def trace_lines(frame, event, arg):
    ...
    @param event: Specifies the intercepted event, such as "call", "line",
...
def trace_calls(frame, event, arg, to_be_traced=None):
    ...
    call originates from a file within a target group trace the function lines
    executed.
