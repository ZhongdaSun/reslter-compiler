...
class ConfigLog(object):
    ...
    __api_resource: bool = False
    __code_generate: bool = False
    __compiler: bool = False
    __config: bool = False
    __dependencies: bool = False
    __find_producer_with_resource_name:bool = False
    __dependencies_analysis_type: bool = False
    __dictionary: bool = False
    __example: bool = False
    __grammar: bool = False
    __swagger: bool = False
    __swagger_spec_preprocess: bool = False
    __swagger_visitor: bool = False
    __work_flow: bool = False
    __utilities: bool = False
    __xms_paths: bool = False

    def __int__(self):
        self.__access_paths: bool = False
        self.__annotations: bool = False
        self.__api_resource: bool = False
        self.__code_generate: bool = False
        self.__compiler: bool = False
        self.__config: bool = False
        self.__dependencies: bool = False
        self.__find_producer_with_resource_name = False
        self.__dependencies_analysis_type: bool = False
        self.__dictionary: bool = False
        self.__example: bool = False
        self.__grammar: bool = False
        self.__swagger: bool = False
        self.__swagger_spec_preprocess: bool = False
        self.__swagger_visitor: bool = False
        self.__work_flow: bool = False
        self.__utilities: bool = False
        self.__xms_paths: bool = False

    def init_from_json(self, config_args):
        self.__access_paths = config_args["access_paths"] if config_args["access_paths"] else False
        self.__annotations = config_args["annotations"] if config_args["annotations"] else False
        self.__api_resource = config_args["api_resource"] if config_args["api_resource"] else False
        self.__code_generate = config_args["code_generate"] if config_args["code_generate"] else False
        self.__compiler = config_args["compiler"] if config_args["compiler"] else False
        self.__config = config_args["config"] if config_args["config"] else False
        self.__dependencies = config_args["dependencies"] if config_args["dependencies"] else False
        self.__find_producer_with_resource_name = (
            config_args)["find_producer_with_resource_name"] \
            if config_args["find_producer_with_resource_name"] else False
        self.__dependencies_analysis_type = config_args["dependencies_analysis_type"] if config_args[
            "dependencies_analysis_type"] else False
        self.__dictionary = config_args["dictionary"] if config_args["dictionary"] else False
        self.__example = config_args["example"] if config_args["example"] else False
        self.__grammar = config_args["grammar"] if config_args["grammar"] else False
        self.__swagger = config_args["swagger"] if config_args["swagger"] else False
        self.__swagger_spec_preprocess = config_args["swagger_spec_preprocess"] if config_args[
            "swagger_spec_preprocess"] else False
        self.__swagger_visitor = config_args["swagger_visitor"] if config_args["swagger_visitor"] else False
        self.__work_flow = config_args["work_flow"] if config_args["work_flow"] else False
        self.__utilities = config_args["utilities"] if config_args["utilities"] else False
        self.__xms_paths = config_args["xms_paths"] if config_args["xms_paths"] else False

        ConfigLog.__instance = self

    @property
    def access_paths(self):
        return self.__access_paths
    ...
    def code_generate(self):
        return self.__code_generate

    @code_generate.setter
    def code_generate(self, is_open: bool):
        self.__code_generate = is_open
    ...
    @property
    def log_find_producer_with_resource_name(self):
        return self.__find_producer_with_resource_name

    @property
    def dependencies_analysis_type(self):
        return self.__dependencies_analysis_type
    ...
    @property
    def swagger_spec_preprocess(self):
        return self.__swagger_spec_preprocess

    @property
    def swagger_visitor(self):
        return self.__swagger_visitor

    @property
    def work_flow(self):
        return self.__work_flow
