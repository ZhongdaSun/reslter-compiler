...
class RestlerSettingsTest(unittest.TestCase):
    ...
    def test_not_yet_initialized(self):
    ...
    def test_command_line_producer_timing_delay(self):
    ...
    def test_invalid_max_request_execution_time(self):
        ...
        user_args = {'max_request_execution_time': MAX_REQUEST_EXECUTION_TIME_MAX + 1}
        settings_file = {
            'max_request_execution_time': MAX_REQUEST_EXECUTION_TIME_MAX + 1
        }
        user_args.update(settings_file)
        with self.assertRaises(InvalidValueError):
            RestlerSettings(user_args, "")
    ...
    def test_settings_file_upload(self):
        ...
        self.assertEqual('C:\\restler\\restlerpayloadbody\\recipe_custom.json',
