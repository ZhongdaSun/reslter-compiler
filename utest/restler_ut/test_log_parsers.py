...
class LogParserTest(unittest.TestCase):
    def test_get_request_sending(self):
        parser = LogParser("")
        req = ParsedRequest(
            'PUT /city/cityName-63a4e53554/house/houseName-31cdd4b5e6 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{}\r\n')
        req_bad = ParsedRequest(
            'GET /city/cityName-63a4e53554/house/houseName-31cdd4b5e6 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{}\r\n')
        get_req = parser._get_request(
            "2020-07-21 08:00:22.584: Sending: 'PUT /city/cityName-63a4e53554/house/houseName-31cdd4b5e6 HTTP/1.1\\r\\nContent-Length: 4\\r\\n\\r\\n{}\\r\\n'\n",
            True)
        get_req_bad = parser._get_request(
            "2020-07-21 08:00:22.584: Sending: 'PUT /city/cityName-63a4e53554 HTTP/1.1\\r\\nContent-Length: 4\\r\\n\\r\\n{}\\r\\n'\n",
            True)
...
class FuzzingLogParserTest(unittest.TestCase):
    def test_parse(self):
        req1 = ParsedRequest(
            'PUT /city/cityName-63a4e53554/house/houseName-31cdd4b5e6 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{}\r\n')
        req2 = ParsedRequest(
            'PUT /city/cityName-63a4e53554/house/houseName-31cdd4b5e6/color/colorName-34782542d1 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{{\r\n')
        ...
        req1 = ParsedRequest(
            'PUT /city/cityName-63a4e53554/house/houseName-ac5a89e704 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{}\r\n')
        req2 = ParsedRequest(
            'GET /city/cityName-63a4e53554/house/houseName-ac5a89e704 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        seq2 = ParsedSequence([req1, req2])
        check1 = ParsedRequest(
            'PUT /city/cityName-63a4e53554/house/houseName-7db9fa94c7 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{}\r\n')
        check2 = ParsedRequest(
            'GET /city/cityName-63a4e53554/house/houseName-7db9fa94c7?api-version=2019-01-01 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        check3 = ParsedRequest(
            'GET /city/cityName-63a4e53554/house/houseName-7db9fa94c7/?/ HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        check4 = ParsedRequest(
            'GET /city/cityName-63a4e53554/house/houseName-7db9fa94c7?? HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        check5 = ParsedRequest(
            'GET /city/cityName-63a4e53554/house/houseName-7db9fa94c7/houseName-7db9fa94c7 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        ...
        req1 = ParsedRequest(
            'PUT /useafterfreetest/useafterfreeTest-87c1bb88f2 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{}\r\n')
        req2 = ParsedRequest(
            'DELETE /useafterfreetest/useafterfreeTest-87c1bb88f2 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        seq3 = ParsedSequence([req1, req2])
        use1 = ParsedRequest('GET /useafterfreetest/useafterfreeTest-87c1bb88f2 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        inv1 = ParsedRequest(
            'PUT /useafterfreetest/useafterfreeTest-268f5f47d2 HTTP/1.1\r\nContent-Length: 4\r\n\r\n{}\r\n')
        inv2 = ParsedRequest(
            'DELETE /useafterfreetest/useafterfreeTest-268f5f47d2?api-version=2019-01-01 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        inv3 = ParsedRequest(
            'DELETE /useafterfreetest/useafterfreeTest-268f5f47d2/?/ HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        inv4 = ParsedRequest(
            'DELETE /useafterfreetest/useafterfreeTest-268f5f47d2?? HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        inv5 = ParsedRequest(
            'DELETE /useafterfreetest/useafterfreeTest-268f5f47d2/useafterfreeTest-268f5f47d2 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
...
class GarbageCollectorLogParserTest(unittest.TestCase):
    def test_parse(self):
        ...
        req1 = ParsedRequest(
            'DELETE /resourcehierarchytest/resourcehierarchyTest-ed70be9d51 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        req2 = ParsedRequest(
            'DELETE /resourcehierarchytest/resourcehierarchyTest-ef837e2d50 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        req3 = ParsedRequest(
            'DELETE /resourcehierarchytest/resourcehierarchyTest-123456 HTTP/1.1\r\nContent-Length: 0\r\n\r\n')
        req_set = {
            req1,
            req1,
            req2,
