...
from rest.restler.engine.fuzzing_parameters.param_combinations import *
from rest.restler.engine.fuzzing_parameters.fuzzing_config import FuzzingConfig

from rest.restler import restler_settings
from rest.restler.restler_settings import Settings
from rest.restler.restler_settings import UninitializedError as UninitializedSettingsError
from rest.restler.engine.core.preprocessing import parse_grammar_schema
...
class SchemaParserTest(unittest.TestCase):
    ...
    def check_equivalence(self, original_req, generated_req, req_collection, fuzzables_equal=True,
                          custom_payloads_equal=True):
        # Fuzzables equal
    ...
    def test_all_data_types_request(self):
        ...
        def test_grammar(grammar_name, dictionary_file_name=None, all_params_required=False):
            ...
            if dictionary_file_name is not None:
                ...
                request_collection.set_custom_mutations(custom_mutations, None, None, None)
                pass
            ...
            for idx, req in enumerate(request_collection):
                ...
                if all_params_required:
                    original_rendering, generated_rendering = \
                        self.check_equivalence(req, required_only_generated_req, request_collection,
                                               fuzzables_equal=True)
