...
request = requests.Request([
            ...
            [
                {
                    "properties":
                        {
                            "port":"""),
    primitives.restler_fuzzable_int("1", examples=["443"]),
    primitives.restler_static_string("""
                        }
                    ,
                    "name":"""),
    ...
    primitives.restler_static_string("""
                            ...
                            ,
                            "protocol":"""),
    primitives.restler_fuzzable_group("protocol", ['Http','Https']  ,quoted=True, examples=["Https"]),
    primitives.restler_static_string(""",
    ...
    primitives.restler_static_string("""
                    ...
                    ,
                    "name":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["appgwhl"]),
    primitives.restler_static_string("""
                },
                {
                    "properties":
    ...
    primitives.restler_static_string("""
                            ...
                            ,
                            "protocol":"""),
    primitives.restler_fuzzable_group("protocol", ['Http','Https']  ,quoted=True, examples=["Http"]),
    primitives.restler_static_string("""
                        }
                    ,
                    "name":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["appgwhttplistener"]),
    primitives.restler_static_string("""
                }
            ]
        }
