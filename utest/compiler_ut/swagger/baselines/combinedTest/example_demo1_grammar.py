...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "storeId":"""),
    primitives.restler_fuzzable_int("1", examples=['"78910"']),
    primitives.restler_static_string(""",
    "rush":"""),
    ...
    [
        {
            "name":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["lemon"]),
    primitives.restler_static_string(""",
            "code":"""),
    primitives.restler_fuzzable_int("1", examples=['"999"']),
    primitives.restler_static_string(""",
            "storeId":"""),
    primitives.restler_fuzzable_int("1", examples=['"\"23\"\'456\""']),
    primitives.restler_static_string("""
        },
        {
            "name":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["apple"]),
    primitives.restler_static_string(""",
            "code":"""),
    primitives.restler_fuzzable_int("1", examples=['"997"']),
    primitives.restler_static_string(""",
            "storeId":"""),
    primitives.restler_fuzzable_int("1", examples=['"3456"']),
    primitives.restler_static_string("""
        },
        {
            "name":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["pear"]),
    primitives.restler_static_string(""",
            "code":"""),
    primitives.restler_fuzzable_int("1", examples=['"998"']),
    primitives.restler_static_string(""",
            "storeId":"""),
    primitives.restler_fuzzable_int("1", examples=['"3457"']),
    primitives.restler_static_string("""
        }
    ]}"""),
    primitives.restler_static_string("\r\n"),
