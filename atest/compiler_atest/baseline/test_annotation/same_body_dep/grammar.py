...
_archive__archiveId__put_archiveId_path = dependencies.DynamicVariable("_archive__archiveId__put_archiveId_path")
    ...
    
    {
        ...
        'post_send':
        {
            ...
            [
                ...
                _archive__archiveId__put_archiveId_path.writer()
            ]
        }
