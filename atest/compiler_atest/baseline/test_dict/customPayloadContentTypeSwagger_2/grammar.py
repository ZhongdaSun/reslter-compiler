...
request = requests.Request([
    ...
    primitives.restler_static_string("/stores/{storeId}/order/post/Content-Type: "),
    primitives.restler_custom_payload_header("/stores/{storeId}/order/post/Content-Type"),
    primitives.restler_static_string("\r\n"),
    primitives.restler_static_string("/stores/{storeId}/order2/post/Content-Type: "),
    primitives.restler_custom_payload_header("/stores/{storeId}/order2/post/Content-Type"),
    primitives.restler_static_string("\r\n"),
    primitives.restler_static_string("/stores/{storeId}/order3/post/Content-Type: "),
